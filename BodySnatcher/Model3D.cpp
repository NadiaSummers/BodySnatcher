//--------------------------------------------------------------------------------------
// Model3D.cpp
// Implementation file for the Model3D class
...
Using Model3D to load a model

To use the model loader, first you need to declare an object of the Model3D type
...
void Model3D::parseLine(char *line)
{
...
void Model3D::parseVertex(char *line)
{
...
void Model3D::parseNormal(char *line)
{
...
void Model3D::parseTexel(char *line)
{
...
void Model3D::parseFace(char *line)
{
...
vector<Vector> Model3D::getVertices()
{
	return vertices;
}

vector<Vector> Model3D::getTexels()
{
	return texels;
}

vector<Vector> Model3D::getNormals()
{
	return normals;
}
